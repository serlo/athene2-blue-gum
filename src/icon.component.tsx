...
import { faTwitterSquare, faFacebookSquare, faGoogle, faWhatsappSquare } from '@fortawesome/free-brands-svg-icons'
...
const icons: iconObject  = {
  ...
  faTwitterSquare: faTwitterSquare, faFacebookSquare: faFacebookSquare, faCircle: faCircle, faVideo: faVideo, faCog: faCog, faShareAlt: faShareAlt, faGoogle: faGoogle, faWhatsappSquare: faWhatsappSquare, faCompass: faCompass
}
